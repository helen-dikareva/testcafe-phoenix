...
describe('press shortcuts tests', function () {
    var PRESS_SHORTCUTS_API_TEST_SRC = './test/functional/tests/automation/press-shortcuts/press-shortcuts.test.js';
    ...
    it('Should successfully run press shortcuts tests', function (done) {
        var run = runner
