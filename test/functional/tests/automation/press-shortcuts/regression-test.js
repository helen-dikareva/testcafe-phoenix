...
describe('regression press shortcuts tests', function () {
    var PRESS_SHORTCUTS_API_TEST_SRC = './test/functional/tests/automation/press-shortcuts/regression.test.js';
    ...
    it('Should successfully run regression press shortcuts tests', function (done) {
        var run = runner
            .reporter('list', process.stdout, formatError)
            .src(PRESS_SHORTCUTS_API_TEST_SRC)
