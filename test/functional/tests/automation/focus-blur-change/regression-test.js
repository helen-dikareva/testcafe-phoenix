...
describe('regression focus, blur, change events tests', function () {
    var TEST_SRC = './test/functional/tests/automation/focus-blur-change/regression.test.js';
    ...
    it('Should successfully run regression focus, blur, change events tests', function (done) {
        var run = runner
