...
describe('regression press api tests', function () {
    var REGRESSION_PRESS_API_TEST_SRC = './test/functional/tests/runner/api/press/regression.test.js';
    ...
    it('Should successfully run tests with regression press functionality', function (done) {
        var run = runner
            .reporter('list', process.stdout, formatError)
            .src(REGRESSION_PRESS_API_TEST_SRC)
