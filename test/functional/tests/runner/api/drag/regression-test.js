...
describe('regression drag api tests', function () {
    var REGRESSION_DRAG_API_TEST_SRC = './test/functional/tests/runner/api/drag/regression.test.js';
    ...
    it('Should successfully run tests with regression drag functionality', function (done) {
        var run = runner
            .reporter('list', process.stdout, formatError)
            .src(REGRESSION_DRAG_API_TEST_SRC)
