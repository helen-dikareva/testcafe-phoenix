...
describe('regression type api tests', function () {
    var REGRESSION_TYPE_API_TEST_SRC = './test/functional/tests/runner/api/type/regression.test.js';
    ...
    it('Should successfully run tests with regression type functionality', function (done) {
        var run = runner
            .reporter('list', process.stdout, formatError)
            .src(REGRESSION_TYPE_API_TEST_SRC)
