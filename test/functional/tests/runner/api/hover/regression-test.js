...
describe('regression hover api tests', function () {
    var REGRESSION_HOVER_API_TEST_SRC = './test/functional/tests/runner/api/hover/regression.test.js';
    ...
    it('Should successfully run tests with regression hover functionality', function (done) {
        var run = runner
            .reporter('list', process.stdout, formatError)
            .src(REGRESSION_HOVER_API_TEST_SRC)
