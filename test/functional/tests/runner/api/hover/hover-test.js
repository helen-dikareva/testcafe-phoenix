...
describe('hover api tests', function () {
    var HOVER_API_TEST_SRC = './test/functional/tests/runner/api/hover/hover.test.js';
    ...
    it('Should successfully run tests with base hover functionality', function (done) {
        var run = runner
            .reporter('list', process.stdout, formatError)
            .src(HOVER_API_TEST_SRC)
