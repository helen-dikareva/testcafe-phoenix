...
describe('dblclick api tests', function () {
    var DBLCLICK_API_TEST_SRC = './test/functional/tests/runner/api/dblclick/dblclick.test.js';
    ...
    it('Should successfully run tests with base dblclick functionality', function (done) {
        var run = runner
            .reporter('list', process.stdout, formatError)
            .src(DBLCLICK_API_TEST_SRC)
