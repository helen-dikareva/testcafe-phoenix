...
describe('rclick api tests', function () {
    var RCLICK_API_TEST_SRC = './test/functional/tests/runner/api/rclick/rclick.test.js';
    ...
    it('Should successfully run tests with base rclick functionality', function (done) {
        var run = runner
            .reporter('list', process.stdout, formatError)
            .src(RCLICK_API_TEST_SRC)
