...
describe('element availability waiting tests', function () {
    var CLICK_API_TEST_SRC = './test/functional/tests/runner/element-waiting/element-waiting.test.js';
    ...
    it('Should successfully run element availability waiting tests', function (done) {
        var run = runner
