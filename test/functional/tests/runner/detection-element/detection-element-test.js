...
describe('detection element after events simulation tests', function () {
    var TEST_SRC = './test/functional/tests/runner/detection-element/detection-element.test.js';
    ...
    it('Should successfully run detection element after events simulation tests', function (done) {
        var run = runner
