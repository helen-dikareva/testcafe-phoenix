...
describe('Test run commands', function () {
    describe('Construction from object and serialization', function () {
        ...
        it('Should create HandleAlertCommand from object', function () {
            var commandObj = {
                type:     TYPE.handleAlert,
                selector: '#yo',
                yo:       'test',
        ...
        it('Should create HandleConfirmCommand from object', function () {
            var commandObj = {
                type:     TYPE.handleConfirm,
                result:   true,
                selector: '#yo',
                yo:       'test',
        ...
        it('Should create HandlePromptCommand from object', function () {
            var commandObj = {
                type:     TYPE.handlePrompt,
                result:   'OK',
                selector: '#yo',
                yo:       'test',
        ...
        it('Should create HandleBeforeUnloadCommand from object', function () {
            var commandObj = {
                type:     TYPE.handleBeforeUnload,
                selector: '#yo',
                yo:       'test',
    ...
    describe('Validation', function () {
        ...
        it('Should validate HandleAlertCommand', function () {
            assertThrow(
                function () {
                    return createCommand({
                        type:    TYPE.handleAlert,
