...
describe('Error formatting', function () {
    describe('Errors', function () {
        ...
        it('Should format "expectedDialogNotAppearedError" message', function () {
            assertErrorMessage('expected-dialog-not-appeared-error', new ExpectedDialogNotAppearedError('alert'));
        });
        ...
        it('Should format "clientFunctionInterruptedByDialogError"', function () {
            assertErrorMessage('client-function-interrupted-by-dialog-error', new ClientFunctionInterruptedByDialogError('eval', 'alert', 'Alert!'));
        });
