...
export class HandleAlertCommand extends HandleDialogCommand {
    constructor (obj) {
        super(obj);
...
export class HandleConfirmCommand extends HandleDialogCommand {
    constructor (obj) {
        super(obj);
...
export class HandlePromptCommand extends HandleDialogCommand {
    constructor (obj) {
        super(obj);
...
export class HandleBeforeUnloadCommand extends HandleDialogCommand {
    constructor (obj) {
        super(obj);
