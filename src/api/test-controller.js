...
export default class TestController {
    ...
    _enqueueAction (apiMethodName, CmdCtor, cmdArgs) {
        ...
        return this._createExtendedPromise(this.testRun.executeCommand(command, callsite), callsite);
    }
    ...
    _handleAlert$ (options) {
        return this._enqueueAction('handleAlert', HandleAlertCommand, { options });
    }

    _handleConfirm$ (result, options) {
        return this._enqueueAction('handleConfirm', HandleConfirmCommand, { result, options });
    }

    _handlePrompt$ (result, options) {
        return this._enqueueAction('handlePrompt', HandlePromptCommand, { result, options });
    }

    _handleBeforeUnload$ (options) {
        return this._enqueueAction('handleBeforeUnload', HandleBeforeUnloadCommand, { options });
    }
}
