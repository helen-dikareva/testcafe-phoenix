...
gulp.task('wrap-scripts-with-templates', ['build-client-scripts'], function () {
    var scripts = [
        { templatePath: './src/client/templates/core.js.mustache', scriptPath: './lib/client/core/index.js' },
        { templatePath: './src/client/templates/ui.js.mustache', scriptPath: './lib/client/ui/index.js' },
        { templatePath: './src/client/templates/runner.js.mustache', scriptPath: './lib/client/runner/index.js' }
    ];
...
gulp.task('build', ['wrap-scripts-with-templates', 'build-styles'], function () {
    ...
    var templates = gulp
        .src(['src/**/*.mustache', '!src/client/templates/*.mustache']);
